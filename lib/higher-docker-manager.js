...
class HigherDockerManager {
    ...
    static getContainerForNameOrId(containerNameOrId) {
        return docker.container
            .list()
            .then(_.curry(HigherDockerManager.findContainerForNameOrId)(_, containerNameOrId));
    }
    ...
    static findContainerForNameOrId(containers, containerNameOrId) {
        ...
        return _.find(containers, (container) => {
            ...
            const prefixedContainerName = '/' + _.trimStart(containerNameOrId, '/');
    ...
    static getContainersForLabel(labelName, labelValue) {
        return docker.container
            .list()
            .then(_.curry(HigherDockerManager.filterContainersByLabel)(_, labelName, labelValue));
    }
